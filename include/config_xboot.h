...
#define DRAM_FIRST_TEST_BEGIN      0x800000
#define DRAM_FIRST_TEST_LEN        1024
#define DRAM_FIRST_TEST_END        (DRAM_FIRST_TEST_BEGIN + DRAM_FIRST_TEST_LEN)

#define DRAM_SECOND_TEST_512M_BEGIN      0x3800000
#define DRAM_SECOND_TEST_512M_LEN        1024
#define DRAM_SECOND_TEST_512M_END        (DRAM_SECOND_TEST_512M_BEGIN + DRAM_SECOND_TEST_512M_LEN)

#define DRAM_SECOND_TEST_1G_BEGIN      0x7000000
#define DRAM_SECOND_TEST_1G_LEN        1024
#define DRAM_SECOND_TEST_1G_END        (DRAM_SECOND_TEST_1G_BEGIN + DRAM_SECOND_TEST_1G_LEN)

#define DRAM_SECOND_TEST_2G_BEGIN      0xF000000
#define DRAM_SECOND_TEST_2G_LEN        1024
#define DRAM_SECOND_TEST_2G_END        (DRAM_SECOND_TEST_2G_BEGIN + DRAM_SECOND_TEST_2G_LEN)

#define DRAM_SECOND_TEST_4G_BEGIN      0x1F000000
#define DRAM_SECOND_TEST_4G_LEN        1024
#define DRAM_SECOND_TEST_4G_END        (DRAM_SECOND_TEST_4G_BEGIN + DRAM_SECOND_TEST_4G_LEN)
