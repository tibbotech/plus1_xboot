...
#define dma_base_addr(adrs)           (((volatile struct card_ctl_regs *)(adrs))->dma_base_addr)
#define hw_dma_ctl(adrs)              (((volatile struct card_ctl_regs *)(adrs))->hw_dma_ctl)
#define card_gclk_disable(adrs)       (((volatile struct card_ctl_regs *)(adrs))->card_gclk_disable)


#define dma_hw_page_addr(adrs)        (((volatile struct card_ctl_regs *)(adrs))->dma_hw_page_addr)
#define dma_hw_page_addr1(adrs)       (((volatile struct card_ctl_regs *)(adrs))->dma_hw_page_addr1)
#define dma_hw_page_addr2(adrs)       (((volatile struct card_ctl_regs *)(adrs))->dma_hw_page_addr2)
#define dma_hw_page_addr3(adrs)       (((volatile struct card_ctl_regs *)(adrs))->dma_hw_page_addr3)
#define dma_hw_page_num0(adrs)        (((volatile struct card_ctl_regs *)(adrs))->dma_hw_page_num0)
#define dma_hw_page_num1(adrs)        (((volatile struct card_ctl_regs *)(adrs))->dma_hw_page_num1)
#define dma_hw_page_num2(adrs)        (((volatile struct card_ctl_regs *)(adrs))->dma_hw_page_num2)
#define dma_hw_page_num3(adrs)        (((volatile struct card_ctl_regs *)(adrs))->dma_hw_page_num3)
#define dma_hw_wait_num(adrs)         (((volatile struct card_ctl_regs *)(adrs))->dma_hw_wait_num)
#define dma_hw_delay_num(adrs)        (((volatile struct card_ctl_regs *)(adrs))->dma_hw_delay_num)
#define dma_debug(adrs)               (((volatile struct card_ctl_regs *)(adrs))->dma_debug)


// CARD_CTL: SD controller
#define boot_ctl(adrs)                (((volatile struct card_sd_regs *)(adrs+1*32*4))->boot_ctl)
#define sd_vol_ctrl(adrs)             (((volatile struct card_sd_regs *)(adrs+1*32*4))->sd_vol_ctrl)
...
#define sdio_ctrl(adrs)               (((volatile struct card_sd_regs *)(adrs+1*32*4))->sdio_ctrl)
...
#define sd_hw_state(adrs)             (((volatile struct card_sd_regs *)(adrs+1*32*4))->sd_hw_state)
...
#define sd_config1(adrs)              (((volatile struct card_sd_regs *)(adrs+1*32*4))->sd_config1)
#define sd_timing_config0(adrs)       (((volatile struct card_sd_regs *)(adrs+1*32*4))->sd_timing_config0)
#define sd_rx_data_tmr(adrs)          (((volatile struct card_sd_regs *)(adrs+1*32*4))->sd_rx_data_tmr)
...
#define sd_cmdbuf0(adrs)              (((volatile struct card_sd_regs *)(adrs+1*32*4))->sd_cmdbuf[3])
#define sd_cmdbuf1(adrs)              (((volatile struct card_sd_regs *)(adrs+1*32*4))->sd_cmdbuf[2])
#define sd_cmdbuf2(adrs)              (((volatile struct card_sd_regs *)(adrs+1*32*4))->sd_cmdbuf[1])
#define sd_cmdbuf3(adrs)              (((volatile struct card_sd_regs *)(adrs+1*32*4))->sd_cmdbuf[0])
#define sd_cmdbuf4(adrs)              (((volatile struct card_sd_regs *)(adrs+1*32*4))->sd_cmdbuf[4])
#define sd_rspbuf0_3(adrs)            (((volatile struct card_sd_regs *)(adrs+1*32*4))->sd_rspbuf0_3)
#define sd_rspbuf4_5(adrs)            (((volatile struct card_sd_regs *)(adrs+1*32*4))->sd_rspbuf4_5)


// CARD_CTL: MS controller
#define ms_wd_data0(adrs)             (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_wd_data[0])
#define ms_wd_data1(adrs)             (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_wd_data[1])
#define ms_wd_data2(adrs)             (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_wd_data[2])
#define ms_wd_data3(adrs)             (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_wd_data[3])
#define ms_wd_data4(adrs)             (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_wd_data[4])
#define ms_wd_data5(adrs)             (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_wd_data[5])
#define ms_wd_data6(adrs)             (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_wd_data[6])
#define ms_wd_data7(adrs)             (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_wd_data[7])
#define ms_wd_data8(adrs)             (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_wd_data[8])
#define ms_wd_data9(adrs)             (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_wd_data[9])
#define ms_wd_data10(adrs)            (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_wd_data[10])
#define ms_wd_data11(adrs)            (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_wd_data[11])
#define ms_wd_data12(adrs)            (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_wd_data[12])
#define ms_wd_data13(adrs)            (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_wd_data[13])
#define ms_wd_data14(adrs)            (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_wd_data[14])
#define ms_wd_data15(adrs)            (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_wd_data[15])
#define ms_piodmarst(adrs)            (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_piodmarst)
#define ms_cmd(adrs)                  (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_cmd)
#define ms_hw_state(adrs)             (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_hw_state)
#define ms_modespeed(adrs)            (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_modespeed)
#define ms_timout(adrs)               (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_timeout)
#define ms_state1(adrs)               (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_state)
#define ms_state2(adrs)               (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_status)
#define ms_rddata0(adrs)              (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_rddata[0])
#define ms_rddata1(adrs)              (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_rddata[1])
#define ms_rddata2(adrs)              (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_rddata[2])
#define ms_rddata3(adrs)              (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_rddata[3])
#define ms_crcbuflsb(adrs)            (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_crcbuf[0])
#define ms_crcbufmsb(adrs)            (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_crcbuf[1])
#define ms_crc_error(adrs)             (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_crc_error)
#define ms_piordy(adrs)               (((volatile struct card_ms_regs *)(adrs+2*32*4))->ms_piordy)
...
#define IS_SDCARD_SLOT()  (gDEV_SDCTRL_BASE_ADRS == (unsigned int)CARD1_CTL_REG)
//#define IS_SDCARD_SLOT()  (0)
#endif
...
#define SET_HW_DMA_BASE_ADDR(DRAMAddr) \
	do{ \
		if (IS_EMMC_SLOT() || IS_SDCARD_SLOT()) { \
			...
			dma_base_addr(gDEV_SDCTRL_BASE_ADRS) = (UINT32) DRAMAddr & 0xffffffff; \
		} \
	}while(0)
